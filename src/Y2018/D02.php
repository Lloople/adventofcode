...
class D02 extends Day
{
    ...
    public function part1()
    {
        ...
        foreach ($this->input as $string) {
            ...
            foreach (str_split($string) as $letter) {
                $occurrences = substr_count($string, $letter);
    ...
    public function part2()
    {
        ...
        foreach ($this->input as $string) {
            ...
            foreach ($this->input as $comparingString) {
        ...
        return implode('', array_intersect(str_split($originalString), str_split($similarString)));
    }
}